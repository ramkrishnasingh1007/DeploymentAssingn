...
const CombinedCalendar = () => {
  ...
  return (
    <div className="bg-gray-100 mt-10 flex items-center justify-center h-[400px]">
      <div className="mx-auto p-6 bg-white rounded-md shadow-md w-[35%] flex flex-col justify-center">
        {/* Card content */}
        ...
        <div className="mb-4">
          ...
          <div className="w-full p-2 h-25 border border-gray-300 rounded focus:outline-none">
            {textareaValue}
          </div>
        </div>
      </div>
